...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
       // -17.6767449,-65.5396272

        // Add a marker in Sydney and move the camera
        LatLng bolivia = new LatLng(-17.6767449,-65.5396272);
        mMap.addMarker(new MarkerOptions().position(bolivia).title("casas en venta en Bolivia").draggable(true));
